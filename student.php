<?php
    ...
    $sql_query_student = "SELECT * FROM `student` WHERE `ssn` = '$ssn'";
    $result_student = mysqli_query($link, $sql_query_student);
...
<body>
    ...
    <div class="main-content">
        <!-- 個人資料區域 -->
        <div class="section">
            <div class="section-title">學生個人資料</div>
            <div class="personal-info">
                <div><label>姓名：<?php echo $row_user["name"];?></label> </div>
                <div><label>學號：<?php echo $row_student["sid"];?></label> </div>
                <div><label>系所：<?php echo $row_student["department"];?></label> </div>
                <div><label>年級：<?php echo $row_student["grade"];?></label> </div>
