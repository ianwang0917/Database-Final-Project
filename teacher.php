<?php
    ...
    $sql_query_teacher = "SELECT * FROM `teacher` WHERE `ssn` = '$ssn'";
    $result_teacher = mysqli_query($link, $sql_query_teacher);
...
<body>
    ...
    <div class="main-content">
        <!-- 個人資料區域 -->
        <div class="section">
            <div class="section-title">指導老師個人資料</div>
            <div class="personal-info">
                <div><label>姓名：<?php echo $row_user["name"];?></label> </div>
                <div><label>學歷：<?php echo $row_teacher["degree"];?></label> </div>
